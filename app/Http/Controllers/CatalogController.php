...
class CatalogController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Ekspresi kasar estimasi harga (supaya bisa dipakai di whereRaw / orderByRaw)
        // NOTE: ini mendekati rumus di view, tapi tanpa faktor 0.8 untuk non-24K.
        // Jika ingin lebih akurat nanti, kita bisa refine.
        ...
        // 5. Filter: rentang harga estimasi
        if ($basePrice24 > 0) {
        ...
        switch ($sort) {
            case 'price_asc':
                if ($basePrice24 > 0) {
                    ...
                    $query->orderBy('labor_cost'); // fallback
                }
                break;
            case 'price_desc':
                if ($basePrice24 > 0) {
